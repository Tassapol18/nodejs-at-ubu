...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[1].nativeElement.textContent).toContain('Dogs');
    expect(de[2].nativeElement.textContent).toContain('Cats');
    ...
    expect(de[1].attributes['routerLink']).toBe('/dogs');
    expect(de[2].attributes['routerLink']).toBe('/cats');
